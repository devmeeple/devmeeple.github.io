...
Windows에서 [Docker](https://www.docker.com/)는 리눅스 커널 기능에 의존하여 WSL2 위에서 동작한다. 
...
![Spring Quickstart Guide Liberica JDK](spring-recommend-liberica-jdk.png 'Spring Quickstart Guide Liberica JDK')
...
[Spring Initializr](https://start.spring.io/)로 생성한 프로젝트는 Gradle Wrapper(`./gradlew`)가 기본으로 포함된다. 
Wrapper는 프로젝트가 요구하는 Gradle 버전으로 자동으로 내려받아 실행하기 때문에, 
전역 [Gradle](https://gradle.org/) 설치 없이도 팀 전체가 동일한 버전으로 빌드할 수 있다.
