...
마침 데이터베이스 관련 세미나가 열렸다. 마침 발표자분도 SNS에서 팔로우하고 있던 분이셨다.
주제도 흥미롭고, 어떤 이야기를 하실지 궁금하여 참여했다.
...
**가장 추천하는 방법은 동료와 페어 프로그래밍(pair programming)이다.** 개인이 할 수 있는 최선은 우선순위 정의하기다.

## 3. 도메인 모델 패턴과 트랜잭션 스크립트 패턴

> 도메인 모델 패턴과 트랜잭션 스크립트 패턴에 자세한 내용은 책[^1]을 참고
...
경험을 공유해 주신 발표도 흥미로웠지만 발표를 마치고 진행된 네트워킹도 인상 깊었다. 오랜만에 참석이라 낯을 가렸는데 발표자 슬기님께서 먼저 다가와주셔서 감사했다.
작년에 가장 재밌게 읽은 책을 슬기님께서도 흥미롭게 읽으신 것 같아서 반가웠다. 가볍게 담소를 나누고 다른 참가자 분들의 고민을 들었다.

경험을 공유하고 나누는 방법은 **재밌게 성장할 수 있는 방법**이라고 생각한다. 막연한 미래지만 하고 싶은 일이 무엇인지 확고하게 다졌다.
