...
스터디가 끝이 났다. 이제 수료식만 남겨뒀다. 전역을 앞둔 말년병장의 기분이다. 구현하는 과정이 대부분 즐거웠지만 모르는 점이 드러나서 슬프기도 했다. 하지만 다시 생각해 보면 지금 발견해서 다행이다.
...
몸이 가벼웠다. 달리기, 학습 어떤 행동도 막힘없었다. 다시 보니 휴식이 긍정적으로 작용했다. 아무것도 하지 않고 쉬었을 때 무기력함보단 오히려 해야 할 것을 하는 지금이 좋다. 내일은 5월의 마지막 주 일요일,
등산도 하고 다음 일정 준비를 잘했으면 좋겠다.

# 26일(일)

기다리던 5월의 마지막 주 일요일. 기대만큼 알차게 보냈다.

## 등산

등산을 다녀왔다. 무난한 인왕산 코스로 다녀올까 했지만 최종선택은 은평둘레길이었다. 은평둘레길을 선택한 이유는 달리기도 병행할 수 있고, 이전과 색다른 코스라서 선택했다. 산행을 할 때마다 느끼지만 고비가
바로 찾아왔다. 증산역부터 둘레길의 시작점까지 가는 길에 언덕이 엄청났다. 둘레길의 수문장이 넌 못 지나간다고 외치고 있었다. 하지만 초반 수문장은 쉽게 넘어갔다. 수문장을 지나니 화장실과 안내판이 기다리고
있었다. 안내판을 봤을 때 코스가 어렵지 않아 보여서 만만하게 생각했다.

초반까지도 좋았다. 이게 산행이지 외치며 오르막을 올랐다. 하지만 너무 많았다. 수많은 수문장이 나를 기다리고 있었다. 만만하게 봤다가 큰코다쳤다. 그동안 3km, 5km 평지 달리기와는 전혀 다른 달리기였다.
평지에서 달릴 땐 컨디션마다 달랐지만 그래도 조금의 여유가 있었다. 그러나 트레일 러닝은 전혀 달랐다. 평소처럼 슬립온을 신고 달렸는데 비포장된 도로에 돌을 만날 때마다 지압판을 걷는 것 같았다. 돈을 벌면
하고 싶은 소비 중에 운동복과 신발도 포함됐었는데 더욱 중요하게 생각해야겠다고 느꼈다.

첫 트레일러닝은 다행히 다치지 않고 끝났다. 기존의 러닝과는 색다른 경험이었다. 현실판 인내의 숲이었다. 여러 고난이 많았던 만큼 나와 솔직한 대화를 나눌 수 있어서 좋았다. 트레일러닝을 하는 순간에는 기존의 근심과
걱정이 없었다. 재밌었고 다음에 벌레가 침공하지 않는다면 꼭 다시 도전하고 싶다. (운동복과 신발이 있을까?)

만족스러운 코스 선택이었지만 긴장이 풀리니 잠이 쏟아졌다. 잠을 조금이라도 자고 왔다면 더 좋았을 것 같다.

## 소비

올해 가장 보람 있는 소비를 했다. 2시간의 산행을 마치고 마시는 아샷추의 맛은 황홀했다. 어떤 감탄사도 필요 없었다. 거대한 울림의 와! 한 글자로 충분했다. 3분도 되지 않아서 음료를 다 마셨다. 순간 더 큰
사이즈를 살걸 그랬나 했지만 아쉬움을 뒤로했다. 아쉬움 덕분에 한 달에 한번 마시는 음료가 더 값지게 느껴졌다.

# 27일(월)

비교적 만족스러운 하루를 보냈다. 일어나서 바로 운동을 하지 않고 오후에 한 점이 결렸는데 오히려 좋았다. 어제 트레일러닝을 해서 그런지 몸이 가벼웠다. 처음에는 극적인 효과가 느껴지지 않았지만 결과를 보니 좋은
페이스로 달리기를 마쳤다. 벌레도 걱정스러웠는데 다행히 방해되지 않았다. (운이 좋았다) 오랜만에 체중을 측정했는데 살이 빠져서 기분이 더욱 좋았다. 개발도 빠르지는 않지만 막힘없었다. 내일은 속도를 붙여도 괜찮을
것 같다. 현재 모든 분야에서 자신감이 붙었다. 최대한 오래 유지되면 좋겠다.

# 28일(화)

기분 좋은 하루가 이어지고 있다. 일어나자마자 운동을 하러 나갔다. 어제에 이어 벌레가 없어서 쾌적하게 달렸다. 에너지 손실을 줄이기 위해 보폭도 줄였는데 속도도 빨라졌다. 물론 힘들다. 개발의 속도를 붙이려
했지만 단위 테스트라는 통곡의 벽 앞에 가로막혔다. 매번 막히는 것 같은데 어떻게 해결하지? 의문이 가득하다. 매번 같은 시도를 하는데 개선이 되지 않는다. 일단 아는 방법으로 문제를 해결해야겠다.

완주러너에 선정됐다. 보안상 전체 메일주소가 공개되지 않아 혹시나 했는데 다행이다. 오프라인 수료식도 참석해서 대화를 나눠야겠다. 재밌다. 인생

# 29일(수)

집으로 돌아오는 길에 대화를 나눴다. 저녁운동을 마치고 도서관으로 향했다. 스프링부트와 학문의 즐거움을 빌렸다. 전자는 방향성을 잡기 위해 빌렸고 후자는 궁금증이 들어 빌렸다. 우연히 허준이 교수의 서울대 축사를
접했다. 전체를 접하지는 못하고 일부를 접했는데, 졸업생들을 가르치려는 모습이 아니라 한 사람의 이야기를 들려주는 모습에 궁금증이 들었다. 어떤 생각을 가지고 살아갈까 곰곰이 생각하다 추천책이라는 문구를 보고
이끌렸다. 아직 1장도 읽지 않았지만 만족스럽다. 가볍게 읽기 좋고 대화를 나누기 적합하다.

## 대화

과거를 회상하며 감사한 사람이 많다고 느꼈다. (아직도 편하게 이야기할 수 있는 유쾌한 주제는 아니지만 그럼에도 이전보다는 나아졌다) 학창 시절 선생님들이 떠올랐다. 초등학교 4학년, 말 못 할 아픔을 겪을 때
숙제가 기억에 난다. 일기를 쓰는 숙제였는데 제출한 일기에 잘했어요 도장과 칭찬이 버티며 살아갈 수 있는 이유였다. 혼자 끙끙 앓고 있었는데 선생님의 도장하나로 힘이 나고 일기를 잘 쓰고 싶다는 생각이 들었다.
백과사전을 펴고 고사성어를 쓰며 일기를 쓰던 모습이 생생하다. 덕분에 고사성어를 접해도 두려움이 없는 것 같다. 감사합니다.

중학생 때는 좋은 선생님이 많았다. 김교림, 김나영, 설경아, 학생주임 선생님등 많은 분들이 떠오르지만 2학년 민동기 선생님이 가장 기억에 남는다. 포기하면 편하셨을 텐데 방황하던 끝까지 이끌어주신 일화가 기억난다.
당시에는 끝까지 내미시는 손이 불편하게 느껴졌는데 만약 그때 잡아주시지 않았다면 중학교 졸업도 못했을 것 같다. 그때 포기하지 않아 주셔서 이후의 행복이 찾아왔고 지금의 내가 존재한다 말해도 과언이 아니다.
감사합니다.

고등학생 때는 큰 어려움이 없었고 최근(?)이기에 더욱 생생하다. 김기중, 조심해, 최은석 선생님이 가장 기억에 남는다. 가끔은 아버지처럼, 친구처럼 교육해 주신 점이 기억에 난다. 감사합니다.

1년 2개월이 지난 지금, 기분 좋은 나날을 보내고 있다. 현실감각 없이 살아가는 것 같아 걱정이 되기도 했고, 무기력하게 보내는 나날도 많았다. 하지만 여러 고난이 지금의 나를 만들었다. 행복도 이 또한
지나갈 것이다. 일희일비하지 않고 나다운 삶을 살기 위해 나아갈 것이다. 수고했어, 오늘도

# 30일(목)

평소와 다른 행보를 보냈다. 도서관에서 배움을 이어나갔다. 총 소요시간은 비슷했는데 만족스럽지는 않았다. 집에서 가볍게 옷을 입고 공부하다가 사복을 입으니 불편했다. 당장 취업을 하지는 않겠지만 슬슬 적응하려 한다.
내일을 준비하고, 예정했던 최소한의 계획을 지켜서 뿌듯하다. 오랜만에 몸도 피곤한데 푹 잠들었으면 좋겠다. (설레는 마음에 잠들지 못하고 밤새는 건 최악이다) 정확히 4개월 만에 방문하는데 또 어떤 물음이
답할지 기대된다.

# 31일(금)

121일 만에 판교를 방문했다. 이전에는 퇴근길에 방문했고 오늘은 출근길에 방문했다. 한번 왔던 길이라서 그런지 낯설지 않았다. (~~ 매일 이었으면 좋겠다~~) 방문하기까지 재밌는 일이 많았는데, 안경 코받침이
떨어졌다. 운동할 때까진 큰 문제가 없었는데 어쩌다 떨어졌는지 모르겠다. 괜히 싸한 기분을 느낀 게 아니었다. 오는 길에 절반이상을 서서 왔는데 허리가 아팠다. 나이가 들었음을 실감했다. 다행인 건 지루하지 않았다.
1시간 동안 책을 읽었는데, 약 70쪽을 읽었다. 돌아가는 길에도 읽으면 완독 할 수 있을 것 같다.

## 학문의 즐거움

기술을 주로 배우고 학문에 중요도는 낮췄던 것 같다. 수학에서 파라미터(Parameter)라는 용어를 사용한다는 점이 신기했다. 대학에서 컴퓨터 과학(Computer Science)을 배울 때 이산수학을 배우는
이유가 이런 점 때문인가? 하는 궁금증이 생겼다. 컴퓨터의 출발점을 알아보고 싶다.

파라미터의 어원을 찾다가 헷갈렸던 개념을 정리했다. Path Paramter와 Query Paramter를 이야기할 때 앞의 단어만 이야기하거나 통용하여 파라미터라고 지칭하는 경우가 많다. 상황에 따라 어떤
파라미터를 사용하는지 추상적으로만 알고 있었는데 개념을 정리했다. 둘 다 결국 파라미터의 종류였다. 이제는 헷갈리지 않는다.

16시간 만에 집에 돌아왔다. 허리와 목이 끊어질 것 같다. 집에서 공부할 때와는 전혀 달랐고 그동안 편안하게 살았다고 느꼈다. 느낀 점을 토대로 어떻게 문제를 해결할 수 있을지 강구해야겠다. 힘들지만 보람찼다.
지금이 가장 적기로 느껴진다. 실패하러 떠나자.
